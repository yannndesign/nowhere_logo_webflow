...
function draw() {
  ...
  slider1.x=windowWidth*0.25;
    slider2.x=windowWidth*0.5;
    slider3.x=windowWidth*0.75;
...
i=0;
  ...
  if (windowWidth<1420) {
  startX=200*(windowWidth/1420)*1.5;
  ...
  // ratio=slider3.value*(windowWidth/1420);
    ...
    if (windowWidth>=1420 && windowWidth<1920) {
  startX=200*(windowWidth/1420)*0.85;
  scale(windowWidth/1420);
  ...
  // ratio=slider3.value*(windowWidth/1420);
      ...
      if (windowWidth>=1920) {
  startX=200*(windowWidth/1420)*0.7;
  scale(windowWidth/1420);
